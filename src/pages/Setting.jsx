            ...
            {activeTab === "data" && (
              <div className="space-y-6">
                ...
                <div className="flex space-x-4 mt-4">
                  ...
                  <button className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 flex items-center" onClick={() => setSaveStatus("")} title="Kosongkan indikator status">
